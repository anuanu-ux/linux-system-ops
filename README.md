...
* *Objective:* Building a strong foundation in CLI-based system management.

## Key Areas Covered
### 1. File System & Navigation
* Used commands like ls -la, cd, and pwd to manage directory structures efficiently.
### 2. Permissions & Security (IAM Basics)
* Practiced chmod and chown to implement Least Privilege access, mimicking Cloud security best practices.
### 3. System Monitoring
